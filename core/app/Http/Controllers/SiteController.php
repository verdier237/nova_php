...
class SiteController extends Controller
{
    ...
    {   
        ...
        if ($reference) {
            ...
            return view($this->activeTemplate . 'user.auth.register', compact('pageTitle', 'sections'));
        }
    ...
    public function plan()
    {
        ...
        return view($this->activeTemplate . 'plan', compact('pageTitle', 'plans', 'sections', 'layout', 'gatewayCurrency','interests','user'));
    }
