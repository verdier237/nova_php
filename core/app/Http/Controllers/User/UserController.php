...
class UserController extends Controller
{
    public function home()
    {
        ...
        return view($this->activeTemplate . 'user.dashboard', $data, compact('plans'));
    }
    ...
    public function referrals()
    {
        ...
        $referral_earnings = Transaction::where('remark', 'referral_commission')->where('user_id', auth()->id())->sum('amount');
        // $referred_users = Transaction::where('remark', 'referral_commission')->where('user_id', auth()->id())->count();
        $referred_users = User::where('ref_by', $user->id)->count();
        return view($this->activeTemplate . 'user.referrals', compact('pageTitle', 'user', 'referred_users', 'maxLevel','referral_earnings'));
    }
    ...
    public function transferBalance()
    {
        ...
        return view($this->activeTemplate . 'user.balance_transfer', compact('pageTitle', 'user','interests'));
    }
