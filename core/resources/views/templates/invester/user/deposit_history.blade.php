                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>@if ($deposit->status == 1) Approved  @elseif ($deposit->status == 2) Pending @elseif ($deposit->status == 3) Rejected @endif</td>
                            <td>{{ diffForHumans($deposit->created_at, 'M d Y @g:i:a') }}</td>
                        </tr>
                        @empty
