                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>{{json_decode($details)->account_number}}</td>
                                            <td>{{json_decode($details)->account_name}}</td>
                                            <td>{{json_decode($details)->amount}} {{__($withdrawal->currency)}}</td>
                                            <td>{{json_decode($details)->bank}}</td>
                                          </tr>
                                        </tbody>
                                      </table>
